...
The statistical analysis and the production of the metagene plot are done in a single step with the function `plot` of the metagene object.

```{r producePlotEx1}
df <- mg$plot()
```

The plot function returns the data.frame that was used by ggplot2 to produce the results.
