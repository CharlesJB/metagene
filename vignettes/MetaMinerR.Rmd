...
Also note that it is not obligatory to use a design file, you can also create the design data.frame using your prefered method (as long as the restriction on the values mentioned previously are respected).

For instance, the previous design data.frame could have been create directly in R:
```{r alternateDesign}
design <- data.frame(Samples = c("align1_rep1.bam", "align1_rep2.bam", "align2_rep1.bam", "align2_rep2.bam"),
