...
Also note that it is not obligatory to use a design file, you can also create the design data.frame using your prefered method (as long as the restrictions on the values mentioned previously are respected).
...
design$Samples <- paste0(system.file("extdata", package="MetaMineR"), "/", design$Samples)
design
```
...
As an alternative to a list of bed files, you can also use GRanges or GRangesList objects.
