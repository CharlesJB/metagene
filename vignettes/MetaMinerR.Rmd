...
It is possible to give MetaMineR text file that contains a list of ensembl gene id as input. The files must be formated in the following way:
...
The MetaMineR package require a vector of the paths (absolute or relative) for every ensembl gene id files to be included in the analysis:
