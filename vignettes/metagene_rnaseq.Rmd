...
more BED files. Here, we use two genes. The name of the files (without the 
...
section. Here, we will use four bam files and two genes.
...
```
Here two genes are drawn on the same plot. Strong solid lines stand for gene 
